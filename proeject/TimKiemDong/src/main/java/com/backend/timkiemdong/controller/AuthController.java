...
public class AuthController {
    ...
    @PostMapping("/list")
    public ResponseEntity<?> getAllAcounts(@RequestBody AcountResponse acountResponse) {
        AcountResponse result = acountService.list(acountResponse);
    ...
    @PostMapping("/update")
    public ResponseEntity<AcountResponse> update(@RequestBody AcountRequest accountRequest) {
        AcountResponse update = acountService.updateAcount(accountRequest);
        return new ResponseEntity<>(update, HttpStatus.OK);
    }


    @PostMapping("/delete")
    public ResponseEntity<AcountResponse> delete(@RequestBody AcountRequest accountRequest) {
        acountService.deleteAcount(accountRequest);
